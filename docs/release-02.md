...
| #26   | E1-H10 | Mapa de disponibilidad                  | El mapa agrupa salas por pabellón o zona y muestra su estado actual: libre, ocupada o en mantenimiento. La actualización se realiza al abrir la vista.                                                                        | 6      |
...
| #30   | E3-H9  | Comunicados institucionales             | El administrador publica comunicaciones persistidas y el sistema recorre por lotes a todos los estudiantes habilitados para encolar los correos.                                                                                | 6      |
...
Los comunicados se procesan en páginas de 200 usuarios hasta cubrir a todos los estudiantes habilitados. Las inasistencias se registran automáticamente al superar los 15 minutos y se muestran en el historial del estudiante; no se presume una sanción que no esté registrada por una regla de negocio. El administrador dispone además de una vista paginada con filtros de estudiante, campus, pabellón, estado y fechas para marcar o corregir la asistencia.
