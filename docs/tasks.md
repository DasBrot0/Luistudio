...
El Release 1 contiene las historias oficiales ya registradas en la documentación del curso.
El Release 2 contiene únicamente historias pendientes o incompletas, evitando solapamientos con funcionalidades ya implementadas.
...
| Front-End     | Agregar filtros por rango de fechas, campus o ubicación.                                                             |
| Back-End      | Crear endpoint`GET /api/admin/analytics/occupancy`.                                                                 |
| Back-End      | Crear endpoint`GET /api/admin/analytics/peak-hours`.                                                                |
| Back-End      | Crear endpoint`GET /api/admin/analytics/top-students`.                                                              |
| Back-End      | Crear endpoint`GET /api/admin/analytics/absence-rate`.                                                              |
